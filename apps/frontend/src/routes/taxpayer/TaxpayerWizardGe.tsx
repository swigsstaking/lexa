...
import { Step1IdentityGe } from '@/components/taxpayer/ge/Step1IdentityGe';
import { Step2RevenuesGe } from '@/components/taxpayer/ge/Step2RevenuesGe';
import { Step3WealthGe } from '@/components/taxpayer/ge/Step3WealthGe';
import { Step4DeductionsGe } from '@/components/taxpayer/ge/Step4DeductionsGe';
import { Step5PreviewGe } from '@/components/taxpayer/ge/Step5PreviewGe';
import { Step6GenerateGe } from '@/components/taxpayer/ge/Step6GenerateGe';
import { WizardSummaryGe } from '@/components/taxpayer/ge/WizardSummaryGe';
...
export function TaxpayerWizardGe() {
    ...
    <div className="min-h-screen bg-bg text-ink flex flex-col">
      ...
      <header className="h-14 border-b border-border bg-surface flex items-center justify-between px-6 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-muted">
            Déclaration d'impôt PP Genève — {year}
          </span>
        </div>
        <div className="flex items-center gap-3">
      ...
      <main className="flex-1 overflow-auto">
        <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            {currentStep === 1 && <Step1IdentityGe draft={draft} year={year} />}
            {currentStep === 2 && <Step2RevenuesGe draft={draft} year={year} />}
            {currentStep === 3 && <Step3WealthGe draft={draft} year={year} />}
            {currentStep === 4 && <Step4DeductionsGe draft={draft} year={year} />}
            {currentStep === 5 && <Step5PreviewGe draft={draft} year={year} />}
            {currentStep === 6 && <Step6GenerateGe draft={draft} year={year} />}
...
// Helper pour les steps GE 1-4 — expose le helper d'update
export function useFieldUpdaterGe(year: number) {
...
// Re-export du helper API pour que Step6Ge puisse call submit-ge
export { lexa };
