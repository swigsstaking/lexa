...
export function Step1Identity({ draft, year }: Props) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted">
          Les données officielles de votre déclaration. Canton fixé à Valais (VS).
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="label" htmlFor="tp-commune">Commune fiscale VS</label>
          <select
            id="tp-commune"
            name="commune"
            className="input"
